...
## [2024-06] 섹션 제목 정렬 문제 해결

### 완료된 일
- 섹션 제목 및 부제목 가운데 정렬 문제 해결
  - section-title 클래스에 text-align: center !important 속성 추가
  - section-title 내부 h2와 p에도 text-align: center !important 적용
  - section-subtitle 클래스에 text-align: center !important 속성 추가
  - !important 속성을 사용하여 다른 CSS 규칙에 의해 덮어쓰이는 문제 방지
- 여러 페이지 구조 분석
  - index.html에서는 h2 직접 사용 방식과 div.section-title 내부에 h2/p 구조 모두 대응
  - 다양한 HTML 구조에서도 모든 섹션 제목이 중앙 정렬되도록 개선

### 해야할 일
- 모든 페이지에서 섹션 제목 정렬 테스트
- 반응형 디자인에서 중앙 정렬 유지 확인
- 필요시 추가 CSS 스타일 규칙 검토 